...
class _TablePageState extends State<TablePage> {
  ...
  Future<void> _fetchTables() async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
          'https://dev-blacforest.vseyal.com/api/tables?where[branch][equals]=$_branchId&limit=1&depth=1',
        ),
  ...
  Future<void> _fetchPendingBills() async {
    ...
    try {
      ...
      final url = Uri.parse(
        'https://dev-blacforest.vseyal.com/api/billings?where[status][in]=pending,ordered,confirmed,prepared,delivered&where[branch][equals]=$_branchId&where[createdAt][greater_than_equal]=$todayStart&limit=100&depth=2',
      );
