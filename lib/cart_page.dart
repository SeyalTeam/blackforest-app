...
class _CartPageState extends State<CartPage> {
  ...
  Future<void> _fetchKitchensForMapping() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'https://dev-blacforest.vseyal.com/api/kitchens?where[branches][contains]=$_branchId&limit=100',
        ),
        headers: {'Authorization': 'Bearer $token'},
      );
      if (response.statusCode == 200) {
  ...
  Future<void> _fetchCompanyDetails(String token, String companyId) async {
    try {
      final response = await http.get(
        Uri.parse(
          'https://dev-blacforest.vseyal.com/api/companies/$companyId?depth=1',
        ),
        headers: {'Authorization': 'Bearer $token'},
      );
  ...
  Future<bool> _isLiveTableOccupied({
    ...
    try {
      ...
      final response = await http.get(
        Uri.https('dev-blacforest.vseyal.com', '/api/billings', lookupParams),
        headers: {'Authorization': 'Bearer $token'},
      );
  ...
  Future<void> _syncCustomerDetailsForFastMode({
    ...
    final url = Uri.parse(
      'https://dev-blacforest.vseyal.com/api/billings/$trimmedBillId?depth=0',
    );
  ...
  Future<void> _submitBilling({
          ...
          if (resolvedBranchId.isNotEmpty && token.isNotEmpty) {
            ...
            final todayStart =
                DateTime(now.year, now.month, now.day)
                    ...
                    .toIso8601String();
            final urlString =
                'https://dev-blacforest.vseyal.com/api/billings?where[branch][equals]=$resolvedBranchId&where[status][in]=pending,ordered,confirmed,prepared&where[createdAt][greater_than_equal]=$todayStart&limit=150&depth=2';
            final tablesUrlString =
                'https://dev-blacforest.vseyal.com/api/tables?where[branch][equals]=$resolvedBranchId&limit=1&depth=1';
    ...
    try {
      ...
      final url = billId != null
          ? Uri.parse(
              'https://dev-blacforest.vseyal.com/api/billings/$billId?depth=0',
            )
          : Uri.parse('https://dev-blacforest.vseyal.com/api/billings?depth=0');
  ...
  Future<void> _printReceipt({
            ...
            if (userId.isNotEmpty) {
              ...
              if (token != null) {
                final userResponse = await http.get(
                  Uri.parse(
                    'https://dev-blacforest.vseyal.com/api/users/$userId?depth=1',
                  ),
                  headers: {'Authorization': 'Bearer $token'},
                );
    ...
    try {
      ...
      if (printer != null) {
        ...
        String billingUrl = 'http://dev-blacforest.vseyal.com/billings';
        String? billingId =
            billingResponse['id'] ??
